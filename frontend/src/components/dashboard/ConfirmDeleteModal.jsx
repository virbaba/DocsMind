      ...
      <div className="bg-[#10121a] border border-[#20223a] rounded-2xl w-full max-w-sm p-6 shadow-[0_8px_40px_rgba(0,0,0,0.7)] relative">
        ...
        <div className="flex items-center justify-end gap-2.5">
          ...
          <button
            ...
            className="py-2 px-4 bg-red-500/10 hover:bg-red-500 border border-red-500/20 hover:border-red-500 text-red-400 hover:text-white rounded-xl text-[11px] font-semibold cursor-pointer transition-all shadow-sm"
          >
            Delete
          </button>
        </div>
